...
public class Climber extends Subsystem {
    ...
    private static final Value EXTENDED = Value.kReverse;
    private static final Value RETRACTED = Value.kForward;
    ...
    public Climber() {
        ...
        climberDrive = new CANSparkMax(6, MotorType.kBrushless );
    ...
    public void frontLegsExtend(boolean flag) {
        if (flag) {
            doubleSolenoid1.set(EXTENDED);
        } else {
            doubleSolenoid1.set(RETRACTED);
        }
    }

    public void backLegsExtend(boolean flag) {
        if (flag) {
            doubleSolenoid2.set(EXTENDED);
        } else {
            doubleSolenoid2.set(RETRACTED);
            //TODO fix me!!!!
    ...
    public boolean isBackLegsExtended() {
        return doubleSolenoid2.get() == EXTENDED;
    }
